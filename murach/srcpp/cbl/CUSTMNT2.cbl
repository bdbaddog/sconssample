      ...
      * added by sam
                   DISPLAY "ACTION IS: " CA-CONTEXT-FLAG
                   EVALUATE TRUE
      ...
      *
           END-EVALUATE.
           DISPLAY "RETURN WITH: " CA-CONTEXT-FLAG
      *    EXEC CICS
      *        RETURN TRANSID('MNT2')
      *               COMMAREA(COMMUNICATION-AREA)
      *    END-EXEC.
           MOVE 11 TO OPENKICKS-CMD
           MOVE 'MNT2' TO OPENKICKS-CHAR4A
      ...
      *    END-EXEC.
           ...
           MOVE 'MNTSET2' TO OPENKICKS-CHAR8B
           ...
           IF VALID-DATA
               ...
               EVALUATE ACTIONI
                   ...
                   WHEN '2'
                       PERFORM 1300-READ-CUSTOMER-RECORD
      * added by sam
                       DISPLAY "FINISH READ: " RESPONSE-CODE
                       IF RESPONSE-CODE = 0
      ...
      *
      * added by sam
           DISPLAY "CUSTOMS KEY IS: " CUSTNO1I
      *    EXEC CICS
      *        READ FILE('CUSTMAS')
      ...
      *
      * added by sam
           DISPLAY "RESPONSE CODE FOR READ IS: " RESPONSE-CODE
      ...
      *
      * add by sam
           DISPLAY "RESPONSE FOR UPDATE IS: ", RESPONSE-CODE
           IF      RESPONSE-CODE NOT = 0
               AND RESPONSE-CODE NOT = 13
               PERFORM 9999-TERMINATE-PROGRAM
           END-IF.
      ...
      *
      * add by sam
           DISPLAY "RESPONSE FOR DELETE IS: ", RESPONSE-CODE
           IF  RESPONSE-CODE NOT = 0
               PERFORM 9999-TERMINATE-PROGRAM
           END-IF.
      *
